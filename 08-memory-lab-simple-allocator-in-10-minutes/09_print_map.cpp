// Build a Simple Memory Allocator: Understanding malloc and new - slide 9: print the block map
// Build: make 09_print_map
#include <cstddef>
#include <iomanip>
#include <iostream>
#include <new>
...
int main() {
    ...
    std::cout << "\ninvariant, checked after every line: payloads + 16 per header = " << ARENA << ": "
              << (ok ? "held" : "BROKEN") << "\n";
    std::cout << "the sizes above are the same on every machine; only the addresses differ\n";
    return ok ? 0 : 1;
}
